...
A window should open showing a grey background, a black canvas, and a colored square in the top left. Congratulations, you just successfully compiled your first program! You're gonna be doing it a lot from now on! In the next section you'll learn how to write some code to get this to display something other than this one square. But remember, every time you modify your code, make sure to compile it so that the executable is created from the current version of your code. 